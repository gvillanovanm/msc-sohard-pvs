...
% ======================================================================= %
% CASE1: just AP acting, ie, bradycardia with normal A-V propagation;
% ======================================================================= %
...
if(fixed_step==.0001)
    ...
    LRIdef                  = 75000   -1;                        % [10-5s]
    AVIdef                  = 23000   -1;                        % [10-5s] 
    ARPdef                  = 15000   -1;                        % [10-5s]
    VRPdef                  = 20000   -1;                        % [10-5s]
    ...
    BPM_programmed          = 1/((LRIdef)/100000)*60;            % [BPM]
end
