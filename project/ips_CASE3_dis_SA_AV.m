...
% ======================================================================= %
% CASE2: bradicardia + resync A-V; slow heart and AP, VP acting.
% ======================================================================= %
...
% ----------------------------------------------------------------------- %
aSensitivity            = 4;                                % [ < aS < ][mV]

R_aFilterSensing        = 1.6e+3;                           % [Ohms]
C_aFilterSensing        = 1e-6;                             % [F]

R1_aSensingAmplifier    = 2;                                % [Ohms]
R2_aSensingAmplifier    = 1;                                % [Ohms]
...
% ----------------------------------------------------------------------- %
Kpath1to3               = 3;
T_min_path_1to3         = 220*Kpath1to3-300;                    % [10-4s]   
T_bac_path_1to3         = 220*Kpath1to3-300;                    % [10-4s]  
T_fwd_path_1to3         = 220*Kpath1to3-300;                    % [10-4s]  

% ----------------------------------------------------------------------- %
% AV path node (PA1_1to7) (the default is 600 for all)
% ----------------------------------------------------------------------- %
Kpath1to7               = 3;
T_min_path_1to7         = 600*Kpath1to7-300;
T_back_path_1to7        = 600*Kpath1to7-300;
T_fwd_path_1to7         = 600*Kpath1to7-300;
...
% AUTOMATA PACEMAKER MODEL:
% how to chose these paremeters to define a specific BPM?
