// -------------------------------------------------------------
// 
// File Name: case2mod_hdl_gen/hdlsrc/case2mod_new/path_aut_block5.v
...
// -------------------------------------------------------------
// 
// Module: path_aut_block5
// Source Path: case2mod_new/PA7_5to7/path_aut
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module path_aut_block5
  ...
  parameter [15:0] bck_param = 38;  // uint16
  // Default encoded enumeration values for type is_PathAutomaton6
  parameter is_PathAutomaton6_IN_AntegradeConduction = 3'd0, is_PathAutomaton6_IN_Conflict = 3'd1, is_PathAutomaton6_IN_Double = 3'd2, is_PathAutomaton6_IN_Idle = 3'd3, is_PathAutomaton6_IN_RetrogradeConduction = 3'd4;
  ...
  reg [2:0] is_PathAutomaton_next;  // enum type is_PathAutomaton6 (5 enums)
  ...
  always @(posedge clk or posedge reset)
    begin : SimpleModeling_c5_sqcjkKS4oBcaRaS68Vk5pPE_path_aut_process
      if (reset == 1'b1) begin
        ...
        outActive1_reg <= 1'b0;
        outActive2_reg <= 1'b0;
        is_PathAutomaton <= is_PathAutomaton6_IN_Idle;
        idle_st <= 1'b1;
      end
      else begin
        if (enb) begin
  ...
  always @(bck_timer_cur, bck_timer_def, forw_param, forw_timer_cur, forw_timer_def,
    ...
    case ( is_PathAutomaton)
      is_PathAutomaton6_IN_AntegradeConduction :
        begin
          if (inActive2) begin
            is_PathAutomaton_next = is_PathAutomaton6_IN_Double;
          end
          else if ((forw_timer_cur_temp == 16'b0000000000000000) &&  ! inActive2) begin
            forw_timer_cur_temp = forw_timer_def_temp;
            outActive2_reg_next = 1'b1;
            is_PathAutomaton_next = is_PathAutomaton6_IN_Conflict;
          end
          else begin
      ...
      is_PathAutomaton6_IN_Conflict :
        begin
          outActive2_reg_next = 1'b0;
          outActive1_reg_next = 1'b0;
          is_PathAutomaton_next = is_PathAutomaton6_IN_Idle;
          idle_st_next = 1'b1;
        end
      is_PathAutomaton6_IN_Double :
        begin
          if (bck_timer_cur_temp == 16'b0000000000000000) begin
            bck_timer_cur_temp = bck_timer_def_temp;
            outActive1_reg_next = 1'b1;
            is_PathAutomaton_next = is_PathAutomaton6_IN_AntegradeConduction;
          end
            ...
            forw_timer_cur_temp = forw_timer_def_temp;
            outActive2_reg_next = 1'b1;
            is_PathAutomaton_next = is_PathAutomaton6_IN_RetrogradeConduction;
          end
          else begin
