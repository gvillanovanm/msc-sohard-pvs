// -------------------------------------------------------------
// 
// File Name: case2mod_hdl_gen/hdlsrc/case2mod_new/node_aut_block1.v
...
module node_aut_block1
  ...
  // Default encoded enumeration values for type is_NodeAutomaton2
  ...
  always @(posedge clk or posedge reset)
    begin : SimpleModeling_c4_sppf4LupdbMSnBPpv0jGkfF_node_aut_process
      if (reset == 1'b1) begin
        state_reg <= 8'd0;
        Active_reg <= 1'b0;
        Trest_cur <= Trest_s;
