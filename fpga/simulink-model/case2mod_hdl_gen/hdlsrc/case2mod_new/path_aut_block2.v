// -------------------------------------------------------------
// 
// File Name: case2mod_hdl_gen/hdlsrc/case2mod_new/path_aut_block2.v
...
// -------------------------------------------------------------
// 
// Module: path_aut_block2
// Source Path: case2mod_new/PA4_1to6/path_aut
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module path_aut_block2
  ...
  // Default encoded enumeration values for type is_PathAutomaton3
  parameter is_PathAutomaton3_IN_AntegradeConduction = 3'd0, is_PathAutomaton3_IN_Conflict = 3'd1, is_PathAutomaton3_IN_Double = 3'd2, is_PathAutomaton3_IN_Idle = 3'd3, is_PathAutomaton3_IN_RetrogradeConduction = 3'd4;
  ...
  reg [2:0] is_PathAutomaton_next;  // enum type is_PathAutomaton3 (5 enums)
  ...
  reg [31:0] cast_1;  // ufix32
  reg [31:0] cast_2;  // ufix32


  always @(posedge clk or posedge reset)
    begin : SimpleModeling_c5_sKsWQe5Kdh9JFwwvtW0IE3D_path_aut_process
      if (reset == 1'b1) begin
        ...
        outActive1_reg <= 1'b0;
        outActive2_reg <= 1'b0;
        is_PathAutomaton <= is_PathAutomaton3_IN_Idle;
        idle_st <= 1'b1;
      end
      else begin
        if (enb) begin
  ...
  always @(bck_timer_cur, bck_timer_def, forw_param, forw_timer_cur, forw_timer_def,
       idle_st, inActive1, inActive2, is_PathAutomaton, outActive1_reg,
       outActive2_reg, pathTimerEn, pathTimerEx, state_reg) begin
    ...
    if ((pathTimerEx > 16'b0000000000000000) && idle_st) begin
      cast_1 = {12'b0, {pathTimerEx, 4'b0000}};
      bck_timer_def_temp = cast_1[15:0];
      bck_timer_cur_temp = bck_timer_def_temp;
    end
    else if ((pathTimerEx > 16'b0000000000000000) &&  ! idle_st) begin
      cast_2 = {12'b0, {pathTimerEx, 4'b0000}};
      bck_timer_def_temp = cast_2[15:0];
    end
    case ( is_PathAutomaton)
      is_PathAutomaton3_IN_AntegradeConduction :
        begin
          if (inActive2) begin
            is_PathAutomaton_next = is_PathAutomaton3_IN_Double;
          end
          else if ((forw_timer_cur_temp == 16'b0000000000000000) &&  ! inActive2) begin
            forw_timer_cur_temp = forw_timer_def_temp;
            outActive2_reg_next = 1'b1;
            is_PathAutomaton_next = is_PathAutomaton3_IN_Conflict;
          end
          else begin
      ...
      is_PathAutomaton3_IN_Conflict :
        begin
          outActive2_reg_next = 1'b0;
          outActive1_reg_next = 1'b0;
          is_PathAutomaton_next = is_PathAutomaton3_IN_Idle;
          idle_st_next = 1'b1;
        end
      is_PathAutomaton3_IN_Double :
        begin
          if (bck_timer_cur_temp == 16'b0000000000000000) begin
            bck_timer_cur_temp = bck_timer_def_temp;
            outActive1_reg_next = 1'b1;
            is_PathAutomaton_next = is_PathAutomaton3_IN_AntegradeConduction;
          end
            ...
            forw_timer_cur_temp = forw_timer_def_temp;
            outActive2_reg_next = 1'b1;
            is_PathAutomaton_next = is_PathAutomaton3_IN_RetrogradeConduction;
          end
          else begin
