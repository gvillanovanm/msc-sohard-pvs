...
// -------------------------------------------------------------
// 
// Module: node_aut_block1
// Source Path: case2mod_new/NA3_RV/node_aut
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module node_aut_block1
  ...
  parameter [15:0] TERP_defs = 250;  // uint16
  parameter [15:0] TERP_s = 250;  // uint16
  parameter [15:0] TRRP_s = 100;  // uint16
  parameter [15:0] Trest_s = 9999;  // uint16
  parameter [15:0] Terp_min = 250;  // uint16
  parameter [15:0] Terp_max = 250;  // uint16
  parameter is_NodeAutomaton2_IN_ERP = 2'd0, is_NodeAutomaton2_IN_RRP = 2'd1, is_NodeAutomaton2_IN_Rest = 2'd2;
  ...
  reg [1:0] is_NodeAutomaton_next;  // enum type is_NodeAutomaton2 (3 enums)
  ...
  always @(posedge clk or posedge reset)
    begin : SimpleModeling_c4_szWf5iSuTCoRpi5BMejntzB_node_aut_process
      if (reset == 1'b1) begin
        state_reg <= 8'd0;
        Active_reg <= 1'b0;
        Trest_cur <= Trest_s;
        ...
        is_NodeAutomaton <= is_NodeAutomaton2_IN_Rest;
      end
      else begin
        if (enb) begin
      ...
      is_NodeAutomaton2_IN_RRP :
        begin
          if (inActive) begin
            ...
            TRRP_cur_next = TRRP_def;
            path_timer_reg_next = 16'd0;
            is_NodeAutomaton_next = is_NodeAutomaton2_IN_Rest;
          end
          else begin
