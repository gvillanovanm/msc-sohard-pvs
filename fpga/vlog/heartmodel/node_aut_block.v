...
// -------------------------------------------------------------
// 
// Module: node_aut_block
// Source Path: case2mod_new/NA2_AV/node_aut
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module node_aut_block
  ...
  parameter is_NodeAutomaton1_IN_ERP = 2'd0, is_NodeAutomaton1_IN_RRP = 2'd1, is_NodeAutomaton1_IN_Rest = 2'd2;
  ...
  reg [1:0] is_NodeAutomaton_next;  // enum type is_NodeAutomaton1 (3 enums)
  ...
  always @(posedge clk or posedge reset)
    begin : SimpleModeling_c4_s1xDqgOO5UWpFPid2aCOBUB_node_aut_process
      if (reset == 1'b1) begin
        state_reg <= 8'd0;
        Active_reg <= 1'b0;
        Trest_cur <= Trest_s;
        ...
        is_NodeAutomaton <= is_NodeAutomaton1_IN_Rest;
      end
      else begin
        if (enb) begin
      ...
      is_NodeAutomaton1_IN_RRP :
        begin
          if (inActive) begin
            ...
            TRRP_cur_next = TRRP_def;
            path_timer_reg_next = 16'd0;
            is_NodeAutomaton_next = is_NodeAutomaton1_IN_Rest;
          end
          else begin
